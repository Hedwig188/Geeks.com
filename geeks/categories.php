    ...
    <div class="col-md-6">
        <div class="content-box-large">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="CatProcess.php" method="post" onsubmit="return validateCat()">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="catDesc" id="catDesc" placeholder="Category Description.." rows="3"></textarea>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button id = "addCat" type="submit" class="btn btn-primary">Add Category</button>
                        </div>
                    </div>
                </form>
            </div>
