    ...
    <div class="col-md-6">
        <div class="content-box-large">
            <div class="panel-heading">
                <div class="panel-title">Change User</div>
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="changeUserProcess.php" method="post" onsubmit="return addUser()">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-10">                            
                            <input type="password" class="form-control" name="pwd" id="pwd" placeholder="Password" <?php echo 'value="'.$user['userPwd'].'"' ?>>                                                        
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-10">                            
                            <input type="password" class="form-control" name="pwd2" id="pwd2" placeholder="Password" <?php echo 'value="'.$user['userPwd'].'"' ?>>                                                        
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-10">                            
                            <input type="email" class="form-control" name="email" id="email" placeholder="Email Address" <?php echo 'value="'.$user['userEmail'].'"' ?>>                                                        
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button id = "user_btn" type="submit" class="btn btn-primary">Change User</button>
                        </div>
                    </div>
                </form>
            </div>
