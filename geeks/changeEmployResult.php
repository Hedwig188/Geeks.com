    ...
    <div class="col-md-6">
        <div class="content-box-large">
            <div class="panel-heading">
                <div class="panel-title">Change Employee</div>
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="changeEmployProcess.php" method="post" onsubmit="return addEmpoly()">
                    <div class="form-group ">
                        <label for="userid" class="col-sm-2 control-label">User Id</label>
                        <div class="col-sm-10">                            
                            <input type="text" class="form-control" name="userid" id="userid" placeholder="User Id" <?php echo 'value="'.$em['userId'].'"' ?>>                                                        
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-10">                            
                            <input type="text" class="form-control" name="emid" id="emid" placeholder="Employee Id" <?php echo 'value="'.$em['employId'].'"' ?>>                                                        
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-10">                            
                            <input type="text" class="form-control" name="fname" id="fname" placeholder="First name" <?php echo 'value="'.$em['FirstName'].'"' ?>>                                                        
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-10">                            
                            <input type="text" class="form-control" name="lname" id="lname" placeholder="Last name" <?php echo 'value="'.$em['LastName'].'"' ?>>                                                        
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-10">                            
                            <input type="password" class="form-control" name="empwd1" id="empwd1" placeholder="Password" <?php echo 'value="'.$em['password'].'"' ?>>                                                        
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-10">                            
                            <input type="password" class="form-control" name="empwd2" id="empwd2" placeholder="Password" <?php echo 'value="'.$em['password'].'"' ?>>                                                        
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-10">                            
                            <input type="email" class="form-control" name="ememail" id="ememail" placeholder="Email Address" <?php echo 'value="'.$em['email'].'"' ?>>                                                        
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-10">                            
                            <input type="number" class="form-control" name="emage" id="emage" min="1" max="120" <?php echo 'value="'.$em['age'].'"' ?>>                                                        
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <select class="form-control" id="type1" name="type1">
                                <?php echo '<option value="'.$em['type'].'">  '.$em['type'].'</option>'?>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button id = "em_btn" type="submit" class="btn btn-primary">Change Employee</button>
                        </div>
                    </div>
                </form>
            </div>
