...
foreach($od as $row) {
    ...
    $j = 0;
    $total = 0;    
    echo '<div id="od" style="margin-top:20px;">
             <div id="odtbb">
             <div id="odt">&nbsp;&nbsp;Your Order Details</div>
             <div class="odtb" style="margin-left:10px;">product name</div>
             <div class="odtb" style="margin-left:190px;">quantity</div>
             <div class="odtb" style="margin-left:60px;">price</div>
             </div>';
    foreach($odp as $row1) {        
