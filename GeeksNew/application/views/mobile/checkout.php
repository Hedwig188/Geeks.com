...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/mobile/checkout.css">
            ...
            <div id="checkout_content">
                <div id="left">
                    ...
                    <div id="payInfo">
                        ...
                        <div class="pay_div">
                            <label for="bill_name">* Name(first and last):</label><br>
                            <input id="bill_name" type="text">
                            <p id="bn">Please enter the name.</p>
                        </div>                    
                        <div class="pay_div">
                            <label for="bill_type">* Payment Type:</label><br>
                            <select id="bill_type">
                        ...
                        <div class="pay_div">
                            <label for="bill_card">* Card Number</label><br>
                        ...
                        <div class="pay_div">
                            <label for="bill_address">* Billing Address:</label><br>
                        ...
                        <div class="pay_div">
                            <label for="bill_zip">* Zip:</label><br>
                            <input id="bill_zip" type="text">
                            <p id="bz">Please enter the zip.</p>
                        </div>
                        <div class="pay_div">
                            <label for="bill_phone">* Phone Number:</label><br>
