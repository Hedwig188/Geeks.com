...
<html>
    ...
    <body>
        ...
        <div id="total_div">
            ...
            <button id="checkout" type="button" onclick="checkoutPro<?php echo '(' . $f . ')' ?>">Process to checkout</button>
        ...
        <div id="yml">
            ...
            <div>
                ...
                foreach($like as $row3) {
                            echo '<div class="e" style="margin-left:70px;font-size:12px;text-align:center;">
        ...
        <div id="bt" style="margin-top: 200px;">
